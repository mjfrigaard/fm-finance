...
Each calculation is also written as an R and Python function—same pattern introduced in the [Budgeting](budgeting.qmd) chapter, now applied to lending math.
