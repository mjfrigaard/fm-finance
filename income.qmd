...
The income chapter is mostly about behavior, but the numbers below can turn that behavior into something you can track. Each calculation below is also written as an R and Python function, which are covered in the callout box below.
