...
The income chapter is mostly about behavior, but three numbers turn that behavior into something you can track. Each calculation below is also written as an R and Python function, following the same pattern introduced in the [Budgeting](budgeting.qmd) chapter.
