...
The `bank_statement` dataset above has the columns typically found in a real bank export (`Date`, `Description`, and `Amount` columns). To get to a `Category` column, you have to map descriptions to your buckets yourself. A small lookup of keyword patterns does the job in one pass.
