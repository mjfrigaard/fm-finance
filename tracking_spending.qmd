...
In R, this is a simple function definition with the formula. Note the rate is given as a decimal and the order of operations. 
...
Python is similar, but the exponential is indicated with `**` (not `^`).
...
In Excel, create a small table with these inputs, then enter the formula in `D2`:

| Cell | Label | Example value |
|------|-------|---------------|
| A2 | Monthly cost | `20` |
| B2 | Years | `30` |
| C2 | Annual return | `0.07` |
| D2 | Opportunity cost | *Formula* |
