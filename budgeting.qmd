...
## The Financial Order of Operations {#sec-foop}

Once you know your income, categorized your expenses, and picked a budgeting framework, the next question is: **where should the leftover money actually go?** Brian Preston (The Money Guy Show) answers this with the **Financial Order of Operations (FOO)** — a fixed sequence of nine steps, each one funded before moving to the next.[^budgeting-3]

[^budgeting-3]: See the full guide at [moneyguy.com/guide/foo](https://moneyguy.com/guide/foo/) [@preston2024foo].
...
The FOO doesn't replace your budget; it tells you [what to do with the money your budget frees up]{style="color:#48a56a; font-weight: bold;"}, one step at a time. Steps 3 and 4 — high-interest debt and emergency reserves — are covered in depth in the next two chapters, and always come before anything else on this list beyond the employer match.
